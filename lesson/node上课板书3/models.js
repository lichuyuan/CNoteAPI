...
class Model {
    ...
    static all() {
        ...
        // return load(this.dbPath()).map(k => this.create(k))
...
// u.save()
// 先在 User 里面找 save 方法, 没有找到
// 然后会在 model 里面找 save 方法, 找到了
// save 是一个实例方法, 所以 this 是 u